...
import demo.app.lirui.horizontalscroll.view.RotatingCircleView;
...
public class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder itemViewHolder, int i) {
        //顶部标题
        TopEntity entity = datas.get(i).getTopEntity();
        itemViewHolder.item_content_num.setText(i+1+".");
        itemViewHolder.item_content_name.setText(entity.getName());
        itemViewHolder.item_content_tag.setText(entity.getTag());
        itemViewHolder.item_content_post.setText(entity.getPost());
        //itemViewHolder.item_content_head.setText(entity.getName());
        ImageLoader.getInstance().bind(entity.getHead(),itemViewHolder.item_content_head);
        //底部滑动部分
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.item_content_num)
        TextView item_content_num;
        @BindView(R.id.item_content_name)
        TextView item_content_name;
        @BindView(R.id.item_content_tag)
        TextView item_content_tag;
        @BindView(R.id.item_content_post)
        TextView item_content_post;
        @BindView(R.id.item_content_head)
        RotatingCircleView item_content_head;
